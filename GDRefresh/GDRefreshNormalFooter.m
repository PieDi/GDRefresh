...
#import "GDRefreshNormalFooter.h"


@interface GDRefreshNormalFooter ()
...
@end
@implementation GDRefreshNormalFooter
...
- (void)placeSubviews
{
    ...
    self.bgView.GD_y = self.GD_size.height-self.bgView.GD_size.height-10;
